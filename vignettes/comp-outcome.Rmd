...
#> Warning: In the future, 'rescor' will be set to FALSE by
#> default for all models. It is thus recommended to explicitely
#> set 'rescor' via 'set_rescor' instead of using the default.
...
#> sd(ilr1_Intercept)     0.33      0.02     0.30     0.37 1.00
#> sd(ilr2_Intercept)     0.30      0.01     0.28     0.34 1.00
#> sd(ilr3_Intercept)     0.39      0.02     0.35     0.43 1.00
#> sd(ilr4_Intercept)     0.30      0.02     0.27     0.33 1.01
#>                    Bulk_ESS Tail_ESS
#> sd(ilr1_Intercept)      984     2019
#> sd(ilr2_Intercept)     1367     2028
#> sd(ilr3_Intercept)     1848     2524
#> sd(ilr4_Intercept)     1604     2019
#> 
#> Population-Level Effects: 
#>                Estimate Est.Error l-95% CI u-95% CI Rhat
#> ilr1_Intercept    -0.43      0.02    -0.48    -0.39 1.01
#> ilr2_Intercept     1.46      0.02     1.42     1.51 1.00
#> ilr3_Intercept    -0.88      0.03    -0.93    -0.82 1.00
#> ilr4_Intercept     0.65      0.02     0.60     0.69 1.00
#> ilr1_STRESS       -0.01      0.00    -0.02    -0.00 1.00
#> ilr2_STRESS        0.01      0.00     0.00     0.01 1.00
#> ilr3_STRESS        0.00      0.00    -0.01     0.01 1.00
#> ilr4_STRESS        0.01      0.00    -0.00     0.01 1.00
#>                Bulk_ESS Tail_ESS
#> ilr1_Intercept     1060     1933
#> ilr2_Intercept     1078     1660
#> ilr3_Intercept     2052     2818
#> ilr4_Intercept     1934     2660
#> ilr1_STRESS        5597     3516
#> ilr2_STRESS        4905     3916
#> ilr3_STRESS        6341     3363
#> ilr4_STRESS        5854     3408
#> 
#> Family Specific Parameters: 
#>            Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
#> sigma_ilr1     0.44      0.01     0.43     0.45 1.00     6407
#> sigma_ilr2     0.38      0.00     0.37     0.39 1.00     6625
#> sigma_ilr3     0.70      0.01     0.68     0.71 1.00     5853
#> sigma_ilr4     0.53      0.01     0.51     0.54 1.00     4974
#>            Tail_ESS
#> sigma_ilr1     3329
#> sigma_ilr2     3272
#> sigma_ilr3     2767
...
#>                   Estimate Est.Error l-95% CI u-95% CI Rhat
#> rescor(ilr1,ilr2)    -0.54      0.01    -0.57    -0.52 1.00
#> rescor(ilr1,ilr3)    -0.18      0.02    -0.21    -0.14 1.00
#> rescor(ilr2,ilr3)    -0.05      0.02    -0.09    -0.02 1.00
#> rescor(ilr1,ilr4)     0.11      0.02     0.07     0.14 1.00
#> rescor(ilr2,ilr4)    -0.05      0.02    -0.08    -0.01 1.00
#> rescor(ilr3,ilr4)     0.56      0.01     0.53     0.58 1.00
#>                   Bulk_ESS Tail_ESS
#> rescor(ilr1,ilr2)     6181     3388
#> rescor(ilr1,ilr3)     4693     3018
#> rescor(ilr2,ilr3)     5906     3466
#> rescor(ilr1,ilr4)     5590     3278
#> rescor(ilr2,ilr4)     6525     3923
#> rescor(ilr3,ilr4)     5916     3176
#> 
