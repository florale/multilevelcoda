...
#> Warning: In the future, 'rescor' will be set to FALSE by default for all models. It is thus recommended to explicitely set 'rescor' via
#> 'set_rescor' instead of using the default.
...
In the frequentist approach, we usually compare the fits of models using `anova()` function.
