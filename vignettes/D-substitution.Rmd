...
#> 
#>     get_legend
#> Error in summary.substitution(object = x, delta = delta, to = to, ref = ref, : An empty data.table returned. Please check that the arguments match with your substitution object.
#> Error in summary.substitution(object = x, delta = delta, to = to, ref = ref, : An empty data.table returned. Please check that the arguments match with your substitution object.
