...
|------:|------:|-------:|-----:|:----|:---|:-------|:---------|
|  0.045| -0.019|   0.105|    10|WAKE |TST |between |grandmean |
|  0.008| -0.027|   0.038|    10|MVPA |TST |between |grandmean |
|  0.012| -0.014|   0.033|    10|LPA  |TST |between |grandmean |
|  0.014| -0.013|   0.036|    10|SB   |TST |between |grandmean |
| -0.040| -0.092|   0.016|   -10|WAKE |TST |between |grandmean |
| -0.008| -0.037|   0.026|   -10|MVPA |TST |between |grandmean |
| -0.012| -0.033|   0.014|   -10|LPA  |TST |between |grandmean |
| -0.014| -0.036|   0.013|   -10|SB   |TST |between |grandmean |
...
|   Mean| CI_low| CI_high| Delta|From |To  |Level  |Reference |
|------:|------:|-------:|-----:|:----|:---|:------|:---------|
|  0.036|  0.006|   0.066|    10|WAKE |TST |within |grandmean |
| -0.006| -0.019|   0.006|    10|MVPA |TST |within |grandmean |
| -0.010| -0.018|  -0.002|    10|LPA  |TST |within |grandmean |
| -0.004| -0.013|   0.006|    10|SB   |TST |within |grandmean |
| -0.030| -0.055|  -0.003|   -10|WAKE |TST |within |grandmean |
|  0.006| -0.006|   0.018|   -10|MVPA |TST |within |grandmean |
|  0.010|  0.002|   0.018|   -10|LPA  |TST |within |grandmean |
|  0.004| -0.006|   0.013|   -10|SB   |TST |within |grandmean |
...
#> Error in `[.data.table`(d0, , object$CompILR$BetweenComp, with = FALSE): Item 1 of j is 494 which is outside the column number range [1,ncol=27]
registerDoSEQ()
```
...
#> Error in eval(expr, envir, enclos): object 'Delta' not found
...
#> 
#>     get_legend
#> Error in plotsub(data = subm2$BetweenSubMargins$TST, x = "between-person sleep", : data must be a data table or data frame,and is an element of a wsub, bsub, wsubmargins, bsubmargins object.
#> Error in plotsub(data = subm2$WithinSubMargins$TST, x = "within-person sleep", : data must be a data table or data frame,and is an element of a wsub, bsub, wsubmargins, bsubmargins object.
```
