...
#> sd(Intercept)     0.99      0.06     0.87     1.11 1.00
#>               Bulk_ESS Tail_ESS
#> sd(Intercept)     1574     2552
#> 
...
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
#> sigma     2.37      0.03     2.31     2.43 1.00     5233
#>       Tail_ESS
#> sigma     2780
#> 
...
|  0.014| -0.014|   0.043|    10|TST |SB   |between |conditional |
| -0.056| -0.117|   0.002|   -10|TST |WAKE |between |conditional |
| -0.005| -0.037|   0.026|   -10|TST |MVPA |between |conditional |
...
```r
plotsub(data = subm1$BetweenpersonSub$TST, x = "sleep", y = "stress")
```
...
|   Mean| CI_low| CI_high| Delta|To  |From |Level  |EffectType  |
|------:|------:|-------:|-----:|:---|:----|:------|:-----------|
|  0.036|  0.007|   0.066|    10|TST |WAKE |within |conditional |
