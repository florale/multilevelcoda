...
```r
summary(subm1, delta = 10, level = "between", to = "TST")
```

   Mean CI_low CI_high Delta From  To   Level Reference
1: 0.06   0.00    0.13    10 WAKE TST between grandmean
2: 0.00  -0.03    0.04    10 MVPA TST between grandmean
3: 0.01  -0.01    0.04    10  LPA TST between grandmean
4: 0.01  -0.02    0.04    10   SB TST between grandmean
...
```r
summary(subm1, delta = 10, level = "within", to = "TST")
```

    Mean CI_low CI_high Delta From  To  Level Reference
1:  0.04   0.00    0.07    10 WAKE TST within grandmean
2: -0.01  -0.02    0.01    10 MVPA TST within grandmean
3: -0.01  -0.02    0.00    10  LPA TST within grandmean
4:  0.00  -0.01    0.01    10   SB TST within grandmean
...
```r
summary(subm2, delta = 10, level, to = "TST")
