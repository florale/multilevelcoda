...
#> sd(Intercept)     0.98      0.06     0.87     1.12 1.00     1466     2608
#> 
#> Population-Level Effects: 
#>           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> Intercept     2.63      0.48     1.66     3.55 1.00     1354     2142
#> bilr1         0.13      0.31    -0.47     0.76 1.00      981     1997
#> bilr2         0.52      0.33    -0.13     1.18 1.00     1160     1678
#> bilr3         0.13      0.22    -0.31     0.56 1.01      892     2038
#> bilr4         0.01      0.28    -0.51     0.58 1.01     1066     1614
#> wilr1        -0.34      0.12    -0.59    -0.10 1.00     3229     2334
#> wilr2         0.05      0.13    -0.21     0.31 1.00     3503     2484
#> wilr3        -0.11      0.08    -0.26     0.05 1.00     2860     2971
#> wilr4         0.23      0.10     0.04     0.43 1.00     3404     3272
#> Female       -0.38      0.17    -0.71    -0.07 1.00     1234     2341
#> 
#> Family Specific Parameters: 
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> sigma     2.37      0.03     2.31     2.43 1.00     4614     2615
#> 
...
|  0.00|  -0.03|    0.04|    10|TST |MVPA |between |clustermean |
|  0.01|  -0.01|    0.03|    10|TST |LPA  |between |clustermean |
|  0.01|  -0.01|    0.04|    10|TST |SB   |between |clustermean |
|  0.05|   0.01|    0.09|    10|TST |WAKE |within  |clustermean |
...
```r
library(ggpubr)
p1 <- plot(subm1, to = "TST", level = "between", ref = "clustermean")
p2 <- plot(subm1, to = "TST", level = "within", ref = "clustermean")
...
#> 
#>     get_legend
#> Error in summary.substitution(object = x, delta = delta, to = to, ref = ref, : An empty data.table returned. Are you sure your arguments are correct?
#> Error in summary.substitution(object = x, delta = delta, to = to, ref = ref, : An empty data.table returned. Are you sure your arguments are correct?
