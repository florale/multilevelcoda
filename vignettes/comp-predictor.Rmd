...
#> [3] wilr1 + wilr2 + wilr3 + wilr4 + (1 | ID)                                 11.72
#> 
...
#> [3] wilr1 + wilr2 + wilr3 + wilr4 + (1 | ID)  2.92
#> [4] 1 + (1 | ID)                             0.249
#> 
...
Output from `bsub()` contains multiple datasets of results for all compositional components. 
