...
#> 
#>     Model                                                                       BF
#> [1] bilr1 + bilr2 + bilr3 + bilr4 + wilr1 + wilr2 + wilr3 + wilr4 + (1 | ID)  4.04
#> [2] bilr1 + bilr2 + bilr3 + bilr4 + (1 | ID)                                 0.339
#> [3] wilr1 + wilr2 + wilr3 + wilr4 + (1 | ID)                                 12.00
#> 
