...
substituted for specific unit(s) at *between* level using a single
reference composition (e.g., compositional mean at sample level). It is
recommended that users run substitution model using the
[`substitution`](https://florale.github.io/multilevelcoda/reference/substitution.md)
function.
