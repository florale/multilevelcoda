...
substituted for specific unit(s) using cluster mean (e.g., compositional
mean at individual level) as reference composition. It is recommended
that users run substitution model using the
[`substitution`](https://florale.github.io/multilevelcoda/reference/substitution.md)
function.
