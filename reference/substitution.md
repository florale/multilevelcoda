...
Estimate the difference in an outcome when compositional parts are
substituted for specific unit(s). The `substitution` output encapsulates
the substitution results for all compositional parts present in the
